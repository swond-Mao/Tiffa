...
export const THEME = {
  ...
  accent: '#005DA2',   // vivid lime — primary accent
  accentBright: '#1F497D',   // highlight lime (gradients / glow)
  accentDeep: '#123B63',   // deep lime (disc cores / shadows)
  accentSoft: '#E8F0F8',   // pale lime wash
  // neutrals (warm-leaning, low chroma)
  ink:    '#0E110B',         // near-black text / dark panels
  inkDim: '#3D413A',
  paper: '#FFFFFF',         // off-white page
  card:   '#FFFFFF',
