...
# parents[4]：data/agent/managed-skills/computer-use 到便携根目录；env PORTABLE_ROOT 由 Tiffa 注入优先
LOG = Path(os.environ.get("PORTABLE_ROOT", Path(__file__).resolve().parents[4])) / "data" / "log" / "computer-use.log"
