...
- [electron/renderer/app.js:465-470](file://electron/renderer/app.js#L465-L470)
...
## 结论
Tiffa 的会话管理与上下文恢复通过"多实例管理 + JSONL 持久化 + 崩溃自动重启 + Mnemopi 语义记忆"形成闭环，确保用户在跨会话、跨项目、甚至进程崩溃场景下仍能获得连贯的智能体体验。**新增的实例清理机制**确保了删除和归档操作的可靠性，**智能滚动跟随机制**提升了用户的交互体验。其设计兼顾性能与可靠性，适合弱模型与本地优先的使用场景。
...
- [electron/renderer/app.js:494-508](file://electron/renderer/app.js#L494-L508)