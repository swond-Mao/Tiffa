...
CheckAPI --> |是| Invoke["ipcRenderer.invoke('tiffa:*' | 'fs:*' | 'shell:*' | 'sessions:*' | 'models:*' | 'config:*' | 'workspace:*' | 'xml-translation:*')"]
...
- [electron/main.js:137-178](file://electron/main.js#L137-L178)
- [electron/preload.js:24-132](file://electron/preload.js#L24-L132)
